...
export default class DiscussList extends Component {
  ...
  getData() {
    axios
      .get('/Discussion?ProjectId=' + this.state.compID)
      .then((response) => {
      ...
      <div className="DiscussListBox">
        <Space>
          ...
          <Radio.Group defaultValue="time" buttonStyle="solid">
            ...
            <Radio.Button value="discussionNum" disabled={true}>
              Likes
            </Radio.Button>
            <Radio.Button value="subscribeNum" disabled={true}>
              Stars
            </Radio.Button>
          </Radio.Group>
        </Space>
