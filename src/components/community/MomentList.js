  ...
  render() {
    return (
      <div>
        <Space>
          <p>sort by:</p>
          <Button type="primary" onClick={this.sortByTime.bind(this)}>
            time
          </Button>
          <Button type="primary" onClick={this.sortByLike.bind(this)}>
            like
          </Button>
          <Button type="primary" onClick={this.sortByComments.bind(this)}>
            comments
          </Button>
          <Button type="primary" onClick={this.sortByFavorites.bind(this)}>
            Favorites
          </Button>
        </Space>
        <List
