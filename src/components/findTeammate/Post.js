...
const Editor = ({ onChange }) => (
  <>
    <TextArea
      rows={5}
      onChange={onChange}
      style={{ width: '80%', resize: 'none', left: '10%' }}
      placeholder="填写入队申请"
    />
  </>
)
...
export default class Post extends Component {
  constructor(props) {
    ...
    console.log(
      '/Post/' + postId + '?projectId=' + MatchId + '&groupId=' + groupId
    )
    axios
      .get('/Post/' + postId + '?projectId=' + MatchId + '&groupId=' + groupId)
      .then((response) => {
